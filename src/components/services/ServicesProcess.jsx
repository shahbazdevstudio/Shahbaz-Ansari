...
const STEPS = [
  {
    num: "01",
    title: "Let's Talk",
    desc: "We start by discussing your project, requirements, and ideas to understand what you need.",
    icon: <FiMessageCircle />,
  },
  {
    num: "02",
    title: "Planning",
    desc: "I review the requirements and outline the project scope, timeline, and next steps before development begins.",
    icon: <FiFileText />,
  },
  {
    num: "03",
    title: "Design & Structure",
    desc: "The layout and structure are planned around your content and requirements with a focus on a clean and easy-to-use experience.",
    icon: <FiPenTool />,
  },
  {
    num: "04",
    title: "Development",
    desc: "I build your website or web application and keep you updated throughout the development process.",
    icon: <FiCode />,
  },
  {
    num: "05",
    title: "Testing & Launch",
    desc: "The project is tested for functionality and responsiveness before it is deployed and made live.",
    icon: <FiGlobe />,
  },
];
