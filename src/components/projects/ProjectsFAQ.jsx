...
const FAQS = [
  {
    ...
    a: "I build business websites, landing pages, dashboards, web applications, and custom solutions using modern web technologies.",
  },
  {
    q: "Can I see a live demo of your projects?",
    a: "Yes. Most projects include a live demo so you can explore the design, features, and overall user experience.",
  },
  {
    q: "Which technologies do you use?",
    a: "I mainly work with React, Next.js, JavaScript, Tailwind CSS, Node.js, Express, MongoDB, and REST APIs.",
  },
  {
    q: "Are these real client projects?",
    a: "Yes. Most of the projects are built for real clients, while some are personal or practice projects created to demonstrate my skills.",
  },
  {
    q: "Can you build a similar project for my business?",
    a: "Absolutely. Every project is customized to match your business goals, branding, and requirements.",
  },
  {
    q: "Do you work on existing websites?",
    a: "Yes. I can improve, redesign, fix bugs, add new features, or optimize an existing website or web application.",
  },
  {
    q: "How can we start a project?",
    a: "Simply send me a message with your project idea. We'll discuss the requirements, timeline, and budget before getting started.",
  },
];
